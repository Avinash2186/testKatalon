...
WebUI.waitForPageLoad(10) // added edited today
...
WebUI.waitForElementVisible(findTestObject('Salesforce_Login/HomePage/Page_Agencies  Salesforce/Agencies_Tab'), GlobalVariable.G_Timeout)

not_run: WebUI.waitForPageLoad(GlobalVariable.G_Timeout)
